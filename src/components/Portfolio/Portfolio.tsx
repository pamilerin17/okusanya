...
import P11 from '../../assets/Screenshot 2026-05-04 103538.png'
const projects = [
 {
...
{
  title: "An E-commerce Pet Store",
  imageSrc: P11,
  tech: ['NEXTJS', 'TailwindCSS', 'Firebase', 'Typescript'],
  demoLink: 'https://pawstore-nu.vercel.app/',
},
];
...
const PortfolioSection = () => {
 return (
   <section id="portfolio" className="container mx-auto px-6 py-16">
     <h2 className="text-4xl font-bold text-gray-900 mb-12 text-center">My <span className='text-blue-500'>Portfolio</span> </h2>
