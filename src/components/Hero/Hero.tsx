    ...
    >
      ...
      <div className="flex-1">
        ...
        <div className="flex gap-6 mt-8 ">
          ...
          <a href="https://www.linkedin.com/in/okusanya-jude-8705582b8/" target="_blank" rel="noopener noreferrer" className="text-gray-700 hover:text-blue-600 text-2xl transition">
            <FaLinkedin />
          </a>
          <a href="https://wa.me/+447344393884" target="_blank" rel="noopener noreferrer" className="text-gray-700 hover:text-blue-600 text-2xl transition">
            <FaWhatsapp />
          </a>
        </div>
      </div>
